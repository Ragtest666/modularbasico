                ...
                <div class="navbar-nav w-100">
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="agregar_cliente.html" class="dropdown-item active">Agregar cliente</a>
                            <a href="ConsultarCliente.html" class="dropdown-item">Ver Clientes</a>
                            <a href="agregar_cliente ejemplo1.html" class="dropdown-item">Editar cliente</a>
                        </div>
                    </div>
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="AgregarProducto.html" class="dropdown-item">Editar Producto</a>
                        </div>
                    </div>
                </div>
            </nav>
