                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="editar_pedido.html" class="dropdown-item active">Editar Pedido</a>
                        </div>
                    </div>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-3 px-3">
                <div class="cafeclaro rounded p-4">
                    ...
                    <a href="editar_pedido.html" class="link">Editar Pedido</a>
                    <h5 class="pt-2 px-4">Editar Pedido</h5>
            <!-- Form Start -->
            <div class="container-fluid pt-2 px-4">
                <div class="row g-4">
                            ...
                            <form>
                                <div class="mb-3">
                                    ...
                                    <select class="form-select mb-3 grispan" aria-label="Default select example">
                                        <option selected>Miguel Angel Patroquio Hernandez</option>
                    ...
                    <div class=""><button type="submit" class="btn col-3" >Guardar Cambios</button></div>
                </div>
            </div>
            <!-- Form End -->
                </div>
